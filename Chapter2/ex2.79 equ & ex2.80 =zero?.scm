...
; main codes are copied from 2.5.1 Generic Arthmetic Operations
...
(define (install-rational-package)
    ...
    (put '=zero? '(rational rational) (lambda (z) (tag (=zero? z))))
    'done)
...
(define (install-complex-package)
    ...
    (put 'equ? '(complex complex) (lambda (z1 z2) (tag (equ-complex? z1 z2))))
    (put '=zero? '(complex complex) (lambda (z) (tag (=zero? z))))
